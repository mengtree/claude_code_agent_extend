...
# ==================== 发件人账户配置 ====================
EMAIL_FROM = "your_email@example.com"  # 发件人邮箱地址
EMAIL_PASSWORD = "your_password_or_app_specific_password"  # 邮箱密码或授权码

# ==================== 默认配置（可选） ====================
DEFAULT_TO = ""                     # 默认收件人邮箱
DEFAULT_SUBJECT = ""                # 默认邮件主题
DEFAULT_FROM_NAME = ""              # 默认发件人显示名称

# ==================== 发送配置 ====================
EMAIL_TIMEOUT = 30                  # 连接超时时间（秒）
MAX attachment_SIZE = 25 * 1024 * 1024  # 最大附件大小（25MB，单位：字节）
